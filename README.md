...
# Приклади заголовка для commita на проекті

## Використовуємо наступні заголовки для комітів:
...
Вибираємо зі списку опис коміту який підходить під вашу задачу, в дужках пишемо
файл в якому працювали, а в тілі коміту розписуємо що змінювали

# GitTutorial

## Список корисних команд для роботи з git в консолі
